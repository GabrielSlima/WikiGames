...
categoriesMock = [
    {'title': "80's fps",
        ...
        ' consectetur adipiscing elit. Nulla pretium,' +
        ' lorem nec mollis ullamcorper, magna nulla lobortis eros,' +
        ' quis feugiat orci ipsum ac lorem. Sed aliquam nisi at' +
        ' dolor volutpat pharetra. Nam tincidunt sagittis risus.' +
        ' Suspendisse egestas gravida faucibus. Mauris viverra tortor' +
        ' ut semper pretium. In tincidunt tellus sed tincidunt hendrerit.' +
        ' Phasellus sem velit, auctor sed erat in, egestas consectetur nisi.' +
        ' Nunc at porttitor nulla. Integer nec lorem luctus, vestibulum diam' +
        ' eget, mollis elit. In at odio non nisl rhoncus scelerisque.' +
        '  Vivamus at hendrerit mauris, non feugiat metus. Nunc velit leo,' +
        ' consectetur in lorem sit amet, sollicitudin ullamcorper orci.' +
        ' Nam eget fermentum libero. Phasellus viverra nisi lobortis felis' +
        ' sodales, sed faucibus arcu molestie.'},
    {'title': "80's ADVENTURE",
        'description': 'Lorem ipsum dolor sit amet,' +
        ' consectetur adipiscing elit. Nulla pretium,' +
        ' lorem nec mollis ullamcorper, magna nulla lobortis eros,' +
        ' quis feugiat orci ipsum ac lorem. Sed aliquam nisi at' +
        ...
        ' Nunc at porttitor nulla. Integer nec lorem luctus, vestibulum diam' +
        ' eget, mollis elit. In at odio non nisl rhoncus scelerisque.' +
        ' at hendrerit mauris, non feugiat metus. Nunc velit leo,r' +
        ' in lorem sit amet, sollicitudin ullamcorper orci. Nam eget Vivamus' +
        ' fermentum libero. Phasellus viverra nisi lobortis felis consectetu' +
        ' sodales, sed faucibus arcu molestie.'}]
usersMock = [
    {
        'name': 'Marlo',
        'email': 'marlon@email.com',
        'picture': 'htts://photos.domain.profile/marlo'
        },
    {
        'name': 'Gerald',
        ...
        },
    {
        ...
        'email': 'whinderssonnunes@email.com',
        'picture': 'htts://photos.domain.profile/marlo'
        }
    ]
gamesMock = [
    {'title': 'Doom',
        ...
        ' shooter video games developed by id Software, and related novels,' +
        ' comics, board games, and film adaptation.',
        'long_description': 'Doom is considered to be one of the ' +
        'pioneering first-person shooter games, introducing to' +
        ' IBM-compatible computers features such as 3D graphics,' +
        ' third-dimension spatiality, networked multiplayer gameplay,' +
        ' and support for player-created modifications with' +
        'the Doom WAD format. Since the release of Doom in 1993, the series' +
        'has spawned numerous sequels, expansion packs, and a film.' +
        'Since its debut, over 10 million copies of games in' +
        'the Doom series have been sold.',
        'category_id': '000',
        'user_id': '000'},
    {'title': 'Counter Strike',
        ...
        'user_id': '000'},
    {'title': 'Zelda',
        'short_description': 'The Legend of Zelda is a fantasy' +
        ' action-adventure video game franchise created by Japanese games' +
        '  designers Shigeru Miyamoto and Takashi Tezuka. It is primarily' +
        ' developed and published by Nintendo, although some portable' +
        ' installments and re-releases have been outsourced to Capcom,' +
        ' Vanpool, and Grezzo. ',
        'long_description': 'The Legend of Zelda is a action-adventure' +
...
def shouldUpdateCategory():
    try:
        category = operations.listCategories()[len(
            operations.listCategories())-1]
        newCategory = categoriesMock[0]
        operations.updateCategory(
            category.id, newCategory['title'],
...
def shouldListGamesOfAspecificCategory():
    try:
        ...
        shouldLishouldListGamesOfAspecificCategorystAspecificGame')
    except Exception as err:
